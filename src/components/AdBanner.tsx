  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 right-4 px-3 py-1 rounded-full bg-muted/30 backdrop-blur-sm border border-border/50">
        <span className="text-[10px] font-bold text-muted-foreground/70 uppercase tracking-wider">#</span>
      </div>
      <p className="text-sm text-muted-foreground/60 font-semibold relative z-10">Рекламное место</p>
      <p className="text-xs text-muted-foreground/40 mt-1 font-medium">Поддержите приложение</p>
    </div>
  );
};
